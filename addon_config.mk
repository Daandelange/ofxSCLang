...
meta:
	ADDON_NAME = ofxSCLang
	ADDON_DESCRIPTION = libSCLang for OpenFrameworks. Interpret SuperCollider language within OpenFrameworks apps.
	ADDON_AUTHOR = @daandelange
	ADDON_TAGS = "bridges" "utilities"
	ADDON_URL = http://github.com/daandelange/ofxSCLang
...
common:
	...
	# Allows defining the parser name in include path, as all parsers have a `parser.c`` and a `scanner.c` file.
	# Eg: `#include "tree-sitter-supercollider/src/parser.c"`
	ADDON_INCLUDES = libs/
	ADDON_INCLUDES += src/
	ADDON_INCLUDES += libs/supercollider/include/common/
	ADDON_INCLUDES += libs/supercollider/include/lang/
	ADDON_INCLUDES += libs/supercollider/include/plugin_interface/
	...
	# Warning : doesn't work --> https://github.com/openframeworks/projectGenerator/issues/287
	#ADDON_DATA = SCLangClassLibrary/*
